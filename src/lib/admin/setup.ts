      ...
      ? [
          {
            ...
            sub: "Anyone that's a part of your brief generation and campaign management. You can be one of them.",
      ...
      ? [
          {
            ...
            sub: "You and your campaign managers can be creators too.",
